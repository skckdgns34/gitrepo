      ...
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
			...
			action="memberManageReportModifyForm.ad" onsubmit="return inputCheck()">
			
                <div class="form-label-group">
               <label for="inputblacklist_no">번호</label><br>
                <input type="text" name="blacklist_no" value="${list.blacklist_no()}" readonly="readonly">
              </div> 
              ...
              <div class="form-label-group">
                              <label for="inputblacklist_reason" >사유</label><br>
								<select
									...
									<option value="f1">비방/욕설</option>
									<option value="f2">음란물 게시</option>
									<option value="f3">무단 광고물 게시</option>
								</select>

              </div>
              <div class="form-label-group">
               <label for="inputmember_no">회원번호</label><br>
                <input type="text" name="member_no" value="${list.reported_member()}" readonly="readonly">
              </div>
              <div class="form-label-group">
