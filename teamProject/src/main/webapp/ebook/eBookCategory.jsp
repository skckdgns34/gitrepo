							...
							<li class="common-filter">
								...
								<ul>
									...
									<c:forEach items="${count}" var="count" varStatus="status">
										<li class="filter-list"><input class="pixel-radio" type="radio" id="r2" name="gen" value="${count.genre }"><label for="r2">${genreName[status.index].genreName }<span> (${count.count})</span></label></li>
									</c:forEach>
