...
<head>
  ...
  <link href="<%=request.getContextPath()%>/resourse/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="★도서등록 url 넣어주세요!">도서조회</a>
            <a class="collapse-item" href="★도서수정 url 넣어주세요!">도서등록</a>
...
<!-- 구분선-->
 ...
 <decorator:body/>
  ...
  <script src="<%=request.getContextPath()%>/resourse/vendor/jquery-easing/jquery.easing.min.js"></script>
  ...
  <script src="<%=request.getContextPath()%>/resourse/js/demo/chart-area-demo.js"></script>
  <script src="<%=request.getContextPath()%>/resourse/js/demo/chart-pie-demo.js"></script>
