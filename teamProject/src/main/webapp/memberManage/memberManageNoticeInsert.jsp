			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form method="post" name="frm" id="frm"
						enctype="multipart/form-data" action="memberManageNoticeInsert.ad">
								...
								<div id="div_id_downloads" class="form-group required">
									...
									<div class="controls col-md-8 ">
										<input class="input-md emailinput form-control"
											...
											placeholder="제목을 입력 해 주세요."  style="width: 1000px;""
											type="text" />
									</div>
								</div>
							</div>
						...
						<div class="col-md-12" style="margin-bottom: 30px;">
							<div id="div_description" class="form-group required">
								...
								<div class="controls col-md-10 ">
									<textarea style="height: 450px; width: 1000px;" id="notice_content"
