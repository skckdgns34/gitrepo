...
public class ClientQuestionWtriteServ implements Controller {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (renameFile.getName().equals("1")) {
		...
		questions.setMember_no(member);
		QuestionDAO.getinstance().insert(questions);
